...
public:
   ...
   */
     ...
     */
    arma::vec encrypt(arma::Mat<long> pk, bool b);
     ...
     */
    bool decrypt(arma::Mat<long> sk, arma::vec c);

    const arma::Mat<long> &getB() { return B; }

    const arma::Mat<long> &getG_inv() { return G_inv; }

    void set_B (const arma::Mat<long> &b) { this->B = b; }

    void set_G_inv (const arma::Mat<long> &g_inv) { this->G_inv = g_inv; }
